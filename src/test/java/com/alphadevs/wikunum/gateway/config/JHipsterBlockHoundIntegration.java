...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.alphadevs.wikunum.gateway.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.alphadevs.wikunum.gateway.security.DomainUserDetailsService", "createSpringSecurityUser");
